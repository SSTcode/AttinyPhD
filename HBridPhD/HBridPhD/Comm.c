...
uint16_t MdbCrc (char *nData, uint8_t wLength)  //Computation of a cyclic redundancy check
{
...
void Comm_init(void)
{
	...
	EVSYS.ASYNCUSER0 = 6;//Asynchronous User Channel Selection
	EVSYS.ASYNCSTROBE = 1 << 3; //Synchronous Channel Strobe
}
...
ISR(USART0_DRE_vect){ // interrup for tx.. use
	USART0.TXDATAL = data_tx[data_count_tx];//Transmit Data Buffer
